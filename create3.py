...
# PDF 업로드
st.header("📎 PDF 이력서 또는 참고자료 업로드 (선택)")
uploaded_file = st.file_uploader("자소서 참고용 PDF 파일을 업로드하세요", type=["pdf"])
...
background = st.text_area("2. 성장 과정 (가치관/성격이 형성된 이야기)", height=100)
experience = st.text_area("3. 직무 관련 경험 (직무와 연결되는 구체 사례)", height=100)
